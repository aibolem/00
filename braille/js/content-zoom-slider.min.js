! function(o) {
    o.fn.contentZoomSlider = function(n) {
        ...
        function l(n) {
            t.css("-moz-transform", `scale(${n}`), t.css("transform-origin", "50%,0"), t.css({
                zoom: n
            }), o(`${i.toolContainer} ${e}`).val(n), o(`${i.toolContainer} .zoom-value`).text((100 * n).toFixed(0) + "%")
        }
        o(i.toolContainer).html(`<div class="row">\n            <div class="col-sm-12 p-1 text-center zoominout">\n                <span class="zoom-value">${i.zoom}%</span>\n                <a href="#" title="Zoom Out" class="zoom-out"> <i class="fa-calendar-minus"></i> </a>\n                <input class="mb-1 ranger" type="range" value="${i.zoom/100}" step="${i.setp/100}" min="${i.min/100}" max="${i.max/100}" />\n                <a href="#" title="Zoom In" class="zoom-in"> <i class="fa-calendar-plus"></i></a>\n            </div>\n        </div>`), o(document).off("click", `${i.toolContainer} .zoom-out`).on("click", `${i.toolContainer} .zoom-out`, function() {
            ! function() {
                let o = a();
